...
Trivia.prototype.play = function(bot) {
    if (this.current) {
...
Trivia.prototype.answer = function(bot, username, guess) {
    ...
    if (AnswerChecker(check_guess, check_answer)) {
        bot.sendChatMsg("[color #00FF00]YOU ARE CORRECT![/color] The answer is " + this.current.answer + "! " + username + " wins [color #00FF00]$" + this.current.points + "[/color]!");
